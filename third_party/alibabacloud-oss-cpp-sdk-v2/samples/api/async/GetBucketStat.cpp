// Demonstrates: Async query storage statistics of a bucket.
...
int main(int argc, char* argv[]) {
    ...
    auto future = client->asyncCall(oss::models::GetBucketStatRequest().setBucket(args.bucket));
    ...
    std::cout << "Storage: " << stat.storage.value_or(0)
              ...
              << ", MultipartUploadCount: " << stat.multipartUploadCount.value_or(0) << std::endl;
    return 0;
}
