// Demonstrates: Query hotlink protection configuration of a bucket.
...
int main(int argc, char* argv[]) {
    ...
    auto outcome = client.getBucketReferer(oss::models::GetBucketRefererRequest().setBucket(args.bucket));
